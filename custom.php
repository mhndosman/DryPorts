...
<head>
    ...
    <title>صفحة  الجمارك - إدارة الميناء البري</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="custom.php">الجمارك</a></li>
    ...
    <main class="container mt-4">
        <h2>فحص الجمارك</h2>
        <p>قم بإدخال بيانات الرحلة وإجراء الفحص الجمركي.</p>
        <form id="customForm" class="mt-4">
            <div class="mb-3">
            ...
            <div class="mb-3 form-check">
                <input type="checkbox" id="smuggling" name="smuggling" class="form-check-input">
                <label for="smuggling" class="form-check-label">تهريب</label>
            </div>
            <div class="mb-3 form-check">
                <input type="checkbox" id="taxs" name="taxs" class="form-check-input">
                <label for="taxs" class="form-check-label">ضرائب</label>
            </div>
            <div class="mb-3 form-check">
                <input type="checkbox" id="fees" name="fees" class="form-check-input">
                <label for="fees" class="form-check-label">رسوم محلية</label>
            </div>
